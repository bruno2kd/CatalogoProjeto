...
# folder onde eh feito o upload das imagens
...
#sqlite soh para dev
engine = create_engine('sqlite:///catalagoestilo.db')
...
def search():
    ...
    # Trying to make it more secure against sql injection attacks but not sure if it
...
def deleteMarca(marca_id):
    ...
    if request.method == 'POST':
        ...
        marcapic = "static/uploads/"+nomeMarca+x+'.jpg'
        ...
        for deleteItem in deleteItens:
            ...
            itemPic = "static/uploads/"+nomeMarca+x+nomeItem+y+'.jpg'
